...
when we call we just set this.argument as the first parameter of call().... Hover to see...
then after then we simply use comma (,) to write parameters of the Method we are calling as parameters of call....

3. call() and apply() are almost same in a sense that we also don't need to set the return value of Method in a function like call.... Difference is:- as first parameter of apply() we again set the this.argument reference object but we don't use comma (,) after comma (,) to set  parameters of Method as other parameters of apply()....
