...
In methods when we call another property to use as parameters we use (this.):-entranceExam ... Otherwise we can also give parameters to that function from outside the object when we are going to call it:- currentBalance...
